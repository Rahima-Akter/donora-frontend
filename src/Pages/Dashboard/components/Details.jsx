            ...
            <div className='flex justify-center items-center m-auto min-h-screen bg-red-50 dark:bg-gray-800'>
                <div className="max-w-2xl m-auto px-8 py-4 bg-white rounded-lg shadow-md dark:shadow-gray-500 dark:bg-gray-900">
                    <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => setIsOpen(true)} className="px-3 py-1 text-sm font-bold text-gray-100 transition-colors duration-300 transform bg-Red uppercase -mb-2 rounded cursor-pointer hover:bg-Racing-Red" tabIndex="0" role="button">donate</button>
                    </div>
                    ...
                    <div className="mt-2">
                        <p className="mt-2 md:mt-0 text-gray-600 dark:text-gray-300">{details.upazila},<span className='ml-1'>{details.district}</span></p>
                    </div>
                        ...
                        <div className="flex items-end justify-center min-h-screen backdrop-blur-md px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                            ...
                            <div className="relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl dark:bg-gray-900 sm:my-8 sm:w-full sm:max-w-sm sm:p-6 sm:align-middle">
                                <h3 className="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">
                                    Donate Blood To <span className='text-Red uppercase'>{details.recipientName}</span>
                                </h3>
