            ...
            <aside className="flex flex-col w-full h-screen px-4 pb-8 lg:pt-3 pt-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700">
                <div className='lg:block hidden'>
                    ...
                    {/* <div className="flex flex-col items-center mt-3 -mx-2">
                        <img
                            className="object-cover w-16 h-16 mx-2 rounded-full ring ring-Red"
                            src={user?.photoURL}
                            alt="Avatar"
                        />
                        <h4 className="mx-2 mt-2 font-medium text-Red uppercase dark:text-gray-200">{user?.displayName}</h4>
