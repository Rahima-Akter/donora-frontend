      ...
      <aside className="flex flex-col w-full h-screen px-4 pb-8 lg:pt-3 pt-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-50">
        <div className="lg:block hidden">
          <NavLink to="/" className="mx-auto flex justify-start items-center">
            <img className="w-[85px] h-14 mt-2" src={logo} alt="Logo" />
            <span className="-ml-5 text-2xl uppercase text-Red font-bold">
              donora
            </span>
          </NavLink>
        </div>
          ...
          <div className="flex flex-col justify-between flex-1 mt-6">
            <nav>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700         ${
                    isActive ? "bg-gray-100 text-gray-700 dark:bg-gray-800" : ""
                  }`
                }
              >
