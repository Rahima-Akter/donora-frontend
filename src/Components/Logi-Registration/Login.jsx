...
const Login = () => {
    ...
    return (
        <div className="flex md:w-full w-11/12 bg-Red/5 max-w-sm mx-auto overflow-hidden rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl my-7 dark:my-0 md:translate-y-[30%] lg:translate-y-0 translate-y-[8%]">
